						...
						<?php
							...
							if ($result->num_rows > 0) {
								...
								<td>
									...
									<a href='#deleteAdminModal' class='delete' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Delete'>&#xE872;</i></a>
								</td>
								";
								}
							} else { echo "0 results"; }
			...
			<div class="modal-content">
				<form action="newAdmin.php" method="POST" >
					...
					<div class="modal-footer">
						...
						<input type="submit" class="btn btn-success" value="Add" name="addAdmin">
					</div>
				</form>
			</div>
		</div>
