					...
					<table class="table table-striped table-hover" id="data_table">
						...
						<?php
							...
							if ($result->num_rows > 0) {
								...
								echo "
								<td>
									<a href='#editSubjectModal' class='edit' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Edit'>&#xE254;</i></a>
									<a href='#deleteSubjectModal' class='delete' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Delete'>&#xE872;</i></a>
								</td>
								";
								}
							} else { echo "0 results"; }
			...
			<div class="modal-content">
				<form action="newSubject.php" method="POST" >
					...
					<div class="modal-footer">
						...
						<input type="submit" class="btn btn-success" value="Add" name="addSubject">
					</div>
				</form>
			</div>
		</div>
